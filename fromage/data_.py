...
def get_dataset(args, split: str, tokenizer, precision: str = 'fp32') -> Dataset:
  ...
  if split == 'train':
    ...
    elif 'cc3m_narrativa' in args.dataset:
      dataset_paths.append(os.path.join(args.dataset_dir, 'cc3m_portugues_train_narrativa.tsv'))
      image_data_dirs.append(os.path.join(args.image_dir, 'cc3m/training/'))       
    elif 'cc3m_portuguese' in args.dataset:
    ...
    if 'cc3m' in args.val_dataset:
      ...
      dataset_paths.append(os.path.join(args.dataset_dir, 'cc3m_portugues_val_narrativa.tsv'))
      image_data_dirs.append(os.path.join(args.image_dir, 'cc3m/validation/'))           
    elif 'cc3m_portuguese' in args.dataset:
