...
from VGloria.fromage import data_
...
llm_models = ['facebook/opt-125m', 'facebook/opt-350m', 'facebook/opt-1.3b',
              ...
              'facebook/opt-66b', 'mistralai/Mistral-7B-v0.1', 'mistralai/Mistral-7B-Instruct-v0.1',
              'meta-llama/Llama-2-7b-hf', "NOVA-vision-language/GlorIA-1.3B", "EleutherAI/gpt-neo-1.3B",
...
def main_worker(gpu, ngpus_per_node, args):
  ...
  # Data loading code
  train_dataset = data_.get_dataset(args, 'train', tokenizer)
  val_dataset = data_.get_dataset(args, 'val', tokenizer)
